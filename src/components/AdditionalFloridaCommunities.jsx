...
function AdditionalFloridaCommunities() {
    ...
    useEffect(() => {
      ...
      const getAllPosts = async () => {
        const res = await axios.get(`https://univisionz.in/aal/public/api/unsponsored/16`)
...
export default AdditionalFloridaCommunities